...
import com.lunaticcat.yourbuddycal.entity.IEntityMultiPart;
...
public class CalsPartEntity extends Entity implements IEntityAdditionalSpawnData
{
	...
	public CalsPartEntity(IEntityMultiPart entityMultiPart, int id, float width, float height)
	{
