...
public class EntityBigPart extends Entity implements IEntityAdditionalSpawnData
{
	...
	{
		return entityIn == this || this.group != null && (entityIn == this.group.parent || entityIn instanceof com.lunaticcat.yourbuddycal.entity.EntityBigPart && ((com.lunaticcat.yourbuddycal.entity.EntityBigPart) entityIn).group == this.group);
	}
